...
export type ProjectAppearanceError = {
  readonly name: "ProjectAppearanceError"
...
export type SessionsRecoveryInput = { readonly sessionID: { readonly sessionID: string }["sessionID"] }

export type SessionsRecoveryOutput = {
  readonly data:
    | { readonly type: "running" }
    | { readonly type: "idle" }
    | { readonly type: "pending"; readonly delivery: "steer" | "queue" }
    | {
        readonly type: "needs_recovery"
        readonly reason: "promoted_input" | "incomplete_assistant" | "incomplete_tool" | "continuation"
...
export type IntegrationsAttemptStatusOutput = {
  ...
  readonly data:
    ...
    | { readonly status: "not_found"; readonly attemptID: string }
}
...
export type ServerProjectUpdateInput = {
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
  readonly name?: {
...
export type ServerProjectUpdateOutput = {
  readonly location: {
    readonly directory: string
    readonly workspaceID?: string
    readonly project: { readonly id: string; readonly directory: string }
...
export type ServerMcpConnectInput = {
...
export type ServerMcpConnectOutput = {
  readonly location: {
    readonly directory: string
    readonly workspaceID?: string
    readonly project: { readonly id: string; readonly directory: string }
...
export type ServerMcpDisconnectInput = {
  readonly serverID: { readonly serverID: string }["serverID"]
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
...
export type ServerMcpDisconnectOutput = {
  readonly location: {
    readonly directory: string
    readonly workspaceID?: string
    readonly project: { readonly id: string; readonly directory: string }
...
export type ServerMcpReconnectInput = {
  readonly serverID: { readonly serverID: string }["serverID"]
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
...
export type ServerMcpReconnectOutput = {
  readonly location: {
    readonly directory: string
    readonly workspaceID?: string
    readonly project: { readonly id: string; readonly directory: string }
...
export type ServerMcpTestInput = {
  readonly serverID: { readonly serverID: string }["serverID"]
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
...
export type ServerMcpTestOutput = {
  readonly location: {
    readonly directory: string
    readonly workspaceID?: string
    readonly project: { readonly id: string; readonly directory: string }
