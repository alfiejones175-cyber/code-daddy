import type {
  ...
  SessionsGetInput,
  SessionsGetOutput,
  SessionsRecoveryInput,
  SessionsRecoveryOutput,
  SessionsResumeInput,
  ...
  ServerProjectUpdateInput,
  ServerProjectUpdateOutput,
  ServerMcpListInput,
  ServerMcpListOutput,
  ServerMcpConnectInput,
  ServerMcpConnectOutput,
  ServerMcpDisconnectInput,
  ServerMcpDisconnectOutput,
  ServerMcpReconnectInput,
...
export function make(options: ClientOptions) {
  ...
  return {
    ...
    sessions: {
      ...
      recovery: (input: SessionsRecoveryInput, requestOptions?: RequestOptions) =>
        request<{ readonly data: SessionsRecoveryOutput }>(
          {
            method: "GET",
            path: `/api/session/${encodeURIComponent(input.sessionID)}/recovery`,
            successStatus: 200,
    ...
    "server.project": {
      update: (input?: ServerProjectUpdateInput, requestOptions?: RequestOptions) =>
        request<ServerProjectUpdateOutput>(
          {
            method: "PATCH",
            path: `/api/project/current/appearance`,
            query: { location: input?.["location"] },
    ...
    "server.mcp": {
      ...
      connect: (input: ServerMcpConnectInput, requestOptions?: RequestOptions) =>
        request<ServerMcpConnectOutput>(
          {
            method: "POST",
            path: `/api/mcp/${encodeURIComponent(input.serverID)}/connect`,
            query: { location: input["location"] },
            successStatus: 200,
            declaredStatuses: [401, 400],
            empty: false,
      ...
      disconnect: (input: ServerMcpDisconnectInput, requestOptions?: RequestOptions) =>
        request<ServerMcpDisconnectOutput>(
          {
            method: "POST",
            path: `/api/mcp/${encodeURIComponent(input.serverID)}/disconnect`,
            query: { location: input["location"] },
            successStatus: 200,
            declaredStatuses: [401, 400],
            empty: false,
      ...
      reconnect: (input: ServerMcpReconnectInput, requestOptions?: RequestOptions) =>
        request<ServerMcpReconnectOutput>(
          {
            method: "POST",
            path: `/api/mcp/${encodeURIComponent(input.serverID)}/reconnect`,
            query: { location: input["location"] },
            successStatus: 200,
            declaredStatuses: [401, 400],
            empty: false,
      ...
      preset: (input: ServerMcpPresetInput, requestOptions?: RequestOptions) =>
        request<ServerMcpPresetOutput>(
          {
            method: "POST",
            path: `/api/mcp/preset/${encodeURIComponent(input.presetID)}`,
            query: { location: input["location"] },
            successStatus: 200,
            declaredStatuses: [401, 400],
            empty: false,
      ...
      test: (input: ServerMcpTestInput, requestOptions?: RequestOptions) =>
        request<ServerMcpTestOutput>(
          {
            method: "POST",
            path: `/api/mcp/${encodeURIComponent(input.serverID)}/test`,
            query: { location: input["location"] },
            successStatus: 200,
            declaredStatuses: [401, 400],
            empty: false,
