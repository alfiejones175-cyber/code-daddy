          ...
          <div class="flex w-full flex-col gap-2">
            ...
            <div class="flex items-center gap-3">
              ...
              <div class="flex select-none flex-col gap-[6px] text-[11px] font-[440] leading-none tracking-[0.05px] text-v2-text-text-muted">
                ...
                <span class="font-mono text-[10px]">PNG · JPEG · GIF · WebP · ≤5 MB</span>
                <div class="mt-1 flex gap-2">
                  <ButtonV2 type="button" variant="neutral" onClick={model.iconClick}>
                    {language.t("dialog.directory.action.selectFile")}
                  </ButtonV2>
                  <Show when={model.store.iconOverride}>
                    <ButtonV2 type="button" variant="neutral" onClick={() => model.setStore("iconOverride", "")}>
