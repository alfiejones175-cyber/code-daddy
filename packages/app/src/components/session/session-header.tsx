...
export function SessionHeader(props: { actions?: JSX.Element } = {}) {
      ...
      <Show when={rightMount()} keyed>
        {(mount) => (
          <Portal mount={mount}>
            ...
            >
              <SessionHeaderV2Actions state={v2ActionsState()} actions={props.actions} />
            </Show>
          </Portal>
        )}
      </Show>
...
function SessionHeaderV2Actions(props: { state: SessionHeaderV2ActionsState; actions?: JSX.Element }) {
  const language = useLanguage()
