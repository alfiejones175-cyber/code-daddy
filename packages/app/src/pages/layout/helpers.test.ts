...
describe("layout workspace helpers", () => {
  test("prefers a saved project avatar override over color and discovered URL", () => {
    expect(
      getProjectAvatarSource("project", {
        color: "blue",
        url: "https://example.com/icon.svg",
        override: "data:image/png;base64,override",
      }),
    ).toBe("data:image/png;base64,override")
  })
