...
export function AppBaseProviders(
  ...
  // Apply the requested terminal preset once; later appearance choices remain saved.
  if (typeof window !== "undefined") {
    try {
      if (!localStorage.getItem("opencode-terminal-appearance-v1")) {
        localStorage.setItem("opencode-theme-id", "matrix")
        localStorage.setItem("opencode-color-scheme", "dark")
        localStorage.removeItem("opencode-theme-css-light")
        localStorage.removeItem("opencode-theme-css-dark")
        localStorage.setItem("opencode-terminal-appearance-v1", "true")
      }
    } catch {
