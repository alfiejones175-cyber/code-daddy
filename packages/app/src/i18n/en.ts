...
import { WorkspaceToolsI18n } from "./workspace-tools"

export const dict = {
  ...WorkspaceToolsI18n.dict,
  "recovery.title": "This conversation has unfinished work",
  "recovery.description":
    "Review the last response and tool results before resuming. The next model turn will use the saved history; an interrupted action may already have changed files or external state.",
  "recovery.resume": "Resume after review",
  "recovery.resuming": "Resuming",
  "recovery.failed": "Could not resume. Review the conversation and try again.",
  "recovery.pending.title": "A saved message is waiting to run",
  "recovery.pending.description": "Review the saved message and latest conversation before continuing. Resuming will send it to the model.",
  "recovery.pending.resume": "Continue with saved message",
  "recovery.loadFailed.title": "Could not check recovery status",
  "recovery.loadFailed.description": "Check the server connection, then try again to see whether this conversation needs recovery.",
  "recovery.checking": "Checking…",
  "team.title": "Agent tasks",
  "team.updated": "Updated {{time}}",
  "team.description": "Inspect delegated tasks, open their conversations, and stop work that needs your attention.",
  "team.empty": "No delegated tasks in this conversation yet.",
  "team.more": "Showing the first 100 tasks. Open the project sidebar to browse more conversations.",
  "team.newTask": "Delegate a task",
  "team.task": "Task instructions",
  "team.agent": "Agent",
  "team.model": "Model",
  "team.inheritModel": "Use this conversation's model",
  "team.turnBudget": "Maximum model turns (1–100)",
  "team.budgetHint":
    "A turn is one model request, not a token or cost limit. The agent's configured limit may be lower. A new follow-up starts a fresh allowance.",
  "team.prepare": "Prepare delegated task",
  "team.delegatePrompt":
    "Use the task tool to delegate this work with the following agent, model, and maximum turn allowance. Preserve these settings and report the result:\n{{input}}",
  "team.status.running": "Running",
  "team.status.waiting": "Needs your response",
  "team.status.failed": "Failed",
  "team.status.complete": "Completed",
  "team.status.idle": "Idle — open to inspect the result",
  "capabilities.title": "Capabilities",
  "capabilities.description":
    "Connect tools for this project and check whether the agent can use them. Tool actions still follow your permission settings.",
  "capabilities.chooseProject": "Open a project to configure its tools.",
  "capabilities.legacy": "This server uses the legacy tool settings. Connect to a V2 server to use this workspace.",
  "capabilities.loadFailed": "Could not load or connect tools. Check the server and try again.",
  "capabilities.browser": "Browser",
  "capabilities.xcode": "Xcode",
  "capabilities.openaiDocs": "OpenAI documentation",
  "capabilities.github": "GitHub",
  "capabilities.browserDescription":
    "Use Playwright to navigate, interact, capture screenshots, and inspect console and network errors in a separate browser profile. Setup downloads the Playwright MCP package if needed.",
  "capabilities.xcodeDescription":
    "Connect Apple's Xcode tools. On the server's Mac, open Xcode and enable external agents in Intelligence settings before connecting.",
  "capabilities.openaiDocsDescription":
    "Search and read current OpenAI developer documentation. This public, read-only MCP server does not call the OpenAI API.",
  "capabilities.githubDescription":
    "Inspect repositories, issues, pull requests, and Actions with GitHub's read-only MCP server. Requires Docker; first setup may download an image and open GitHub sign-in.",
  "capabilities.xcodeDetected": "Xcode {{version}} detected on this Mac",
  "capabilities.setup": "Set up",
  "capabilities.test": "Test connection",
  "capabilities.reconnect": "Reconnect",
  "capabilities.disconnect": "Disconnect",
  "capabilities.remove": "Remove",
  "capabilities.removeConfirm": "Remove {{name}} from this project's MCP configuration?",
  "capabilities.addRemote": "Add remote MCP server",
  "capabilities.addRemoteDescription":
    "Agents may send tool inputs to this server. Connect a server you trust; remote account sign-in is not supported yet.",
  "capabilities.serverName": "Server name",
  "capabilities.serverUrl": "Server URL",
  "capabilities.add": "Add server",
  "capabilities.tools": "Available tool definitions: {{count}}",
  "capabilities.state.configured": "Configured",
  "capabilities.state.connected": "Connected",
  "capabilities.state.available": "Available to agents",
  "capabilities.state.failed": "Connection failed",
  "capabilities.state.disabled": "Disabled",
  "common.retry": "Retry",
  "providers.loadFailed": "Could not load providers. Check the server connection and try again.",
  "providers.signInExpired": "This sign-in attempt has expired. Start again to connect your account.",
  "permission.allowProject": "Always allow in this project",
  "permission.projectScope":
    "Always allowing saves permission for {{action}} in project {{project}} for the patterns below, including matching pending requests.",
  "review.prepareFeedback": "Ask agent to address comments",
  "review.feedbackPrompt":
    "Address the attached review comments and verify the changes. Explain what you changed, the checks you ran, and anything that remains unresolved.",
  "review.feedbackReady": "Review feedback is ready in the composer. Edit it before sending.",
  "jevReview.action": "Review response with Jev",
  "jevReview.heading": "Response review",
  "jevReview.description":
    "Jev checks this completed response against your requirement and supplied evidence. This sends the response and evidence to TypeSafe.",
  "jevReview.requirement": "What should this response accomplish?",
  "jevReview.evidence": "Evidence excerpt (optional)",
  "jevReview.evidenceHint": "Paste a relevant test result or source excerpt. Remove secrets first.",
  "jevReview.evidenceUrl": "Evidence link (optional)",
  "jevReview.submit": "Run review",
  "jevReview.running": "Reviewing response…",
  "jevReview.notReviewed": "Not reviewed",
  "jevReview.stale": "This review is stale because the response changed. Run it again before using the findings.",
  "jevReview.unavailable": "Review unavailable. Check Jev settings or the server connection, then retry.",
  "jevReview.invalidInput": "The review input needs a shorter requirement or evidence excerpt.",
  "jevReview.insufficient": "Jev could not determine whether this criterion was met from the supplied material.",
  "jevReview.advisory": "Jev advice only. Check results and file changes remain separate evidence.",
  "jevReview.provenance": "Reviewed with {{model}} · rubric {{version}}",
  "jevReview.changedFiles": "Changed files in this task",
  "jevReview.suppliedEvidence": "Evidence supplied for this review",
  "jevReview.address": "Address findings",
  "jevReview.draftReady": "Findings are ready in the composer. Edit the draft before sending.",
  "jevReview.retry": "Retry review",
  "jevReview.criteria.requirements": "Addresses the requirement",
  "jevReview.criteria.checks": "Supports check claims",
  "jevReview.criteria.completion": "Separates completed and open work",
  "jevReview.criteria.errors": "Gives an actionable error step",
  "jevReview.assessment.supported": "Supported",
  "jevReview.assessment.concern": "Concern",
  "jevReview.assessment.insufficient_evidence": "Insufficient evidence",
  ...
  "dialog.model.unpaid.noFreeModels": "No confirmed free models are available. You can connect a provider below.",
  ...
  "model.price.perMillion": "Input {{input}} · Output {{output}} / 1M tokens",
  "model.price.input": "Input / 1M tokens",
  "model.price.output": "Output / 1M tokens",
  "model.price.unavailable": "Price varies or unavailable",
  ...
  "prompt.action.steer": "Send now",
  "prompt.action.queue": "Queue",
  "prompt.action.queue.description": "Queue after the current task finishes",
  ...
  "prompt.toast.queued.title": "Queued",
  "prompt.toast.queued.description": "Your message will send after the current task finishes.",
  ...
  "home.sessions.search.clear": "Clear session search",
  ...
  "settings.updates.row.check.disabledDescription": "This local build updates when you rebuild and install the app.",
  ...
  "settings.routines.title": "Routines",
  "settings.routines.description":
    "Schedule a prompt for a session. It uses that session's current model and permission settings.",
  "settings.routines.limitations":
    "Edit a routine by deleting it and creating a replacement. History records prompt admission, not task completion. Pause stops future schedules, but an already claimed prompt can still arrive.",
  "settings.routines.unsupported": "Routines require a V2 server.",
  "settings.routines.empty": "No routines scheduled yet.",
  "settings.routines.loadFailed": "Could not load routines. Check the server connection and try again.",
  "settings.routines.create": "Create routine",
  "settings.routines.name": "Name",
  "settings.routines.namePlaceholder": "Repository check",
  "settings.routines.session": "Session",
  "settings.routines.sessionPlaceholder": "Choose a session",
  "settings.routines.prompt": "Prompt",
  "settings.routines.promptPlaceholder": "Check the repository and report anything that needs attention.",
  "settings.routines.schedule": "Repeat every",
  "settings.routines.minutes": "minutes",
  "settings.routines.invalidInterval": "Enter a whole number from 1 to 43,200 minutes.",
  "settings.routines.createFailed": "Could not create the routine. Check the fields and try again.",
  "settings.routines.actionFailed": "Could not update the routine. Try again.",
  "settings.routines.pause": "Pause",
  "settings.routines.resume": "Resume",
  "settings.routines.delete": "Delete",
  "settings.routines.deleteConfirm":
    "Delete {{name}}? Its run history will be removed. An already queued prompt may still run.",
  "settings.routines.status.active": "Active",
  "settings.routines.status.paused": "Paused",
  "settings.routines.nextRun": "Next run {{time}}",
  "settings.routines.history": "Run history",
  "settings.routines.history.hide": "Hide history",
  "settings.routines.history.empty": "No runs recorded yet.",
  "settings.routines.historyFailed": "Could not load run history. Try again.",
  "settings.routines.run.claimed": "Waiting to be admitted",
  "settings.routines.run.admitted": "Queued in the session",
  "settings.routines.run.failed": "Could not queue",
  "settings.routines.run.cancelled": "Cancelled",
  "settings.routines.run.session": "Session {{id}}",
  "settings.routines.run.message": "Message {{id}}",
  ...
  "permission.plugin.jev.review.description":
    "The selected response, requirements, and supplied evidence will be sent to TypeSafe Jev for advisory review.",
  ...
  "xcode.badge.ios": "Xcode",
  "xcode.badge.package": "Swift",
  "xcode.status.missing": "Xcode not found",
  "transcribe.start": "Dictate",
  "transcribe.stop": "Stop dictation",
  "transcribe.listening": "Listening…",
  "transcribe.unsupported": "Voice input is not supported in this window",
  "transcribe.error": "Voice input failed",
  "transcribe.starting": "Starting dictation…",
  "transcribe.stopping": "Finishing dictation…",
  "transcribe.permission":
    "Allow microphone and speech recognition access in system or browser privacy settings, then try again.",
  "transcribe.unavailable":
    "Speech recognition is unavailable. Check that your language is supported and speech recognition is enabled on this device.",
  "transcribe.network": "Speech recognition could not connect. Check your connection and try again.",
  "transcribe.no-speech": "No speech was detected. Check your microphone and try again.",
  "transcribe.busy": "Dictation is already active in another window. Stop it there and try again.",
  "transcribe.failed": "Dictation could not finish. Check your microphone and try again.",
  "transcribe.permission.microphone": "Allow OpenCode to use the microphone for dictation.",
  "transcribe.permission.speech": "Allow OpenCode to turn speech into prompt text using Apple speech recognition.",
