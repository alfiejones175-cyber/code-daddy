...
import type { DictationPlatform } from "@/utils/dictation"
...
type PlatformBase = {
  /** Native speech recognition, when supported by the desktop host. */
  dictation?: DictationPlatform
  ...
  /** Detect local Xcode install (desktop macOS only) */
  xcodeDetect?(): Promise<{ installed: boolean; version?: string; build?: string; developerDir?: string }>

  /** Scan a directory for Xcode project markers (desktop only) */
  xcodeScanProject?(directory: string): Promise<{
    directory: string
